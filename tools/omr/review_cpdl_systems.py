...
<section class="panel score-preview"><h2 style="margin:18px 18px 12px">Visual MusicXML preview</h2><p class="preview-note">The engraved score updates automatically when you move to another system. The XML file stays hidden behind the preview.</p><iframe id="scoreFrame" title="Visual MusicXML score preview"></iframe></section>
