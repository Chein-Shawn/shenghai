...
enum L10n {
    ...
    private static let aliases: [String: String] = {
        guard
            let url = AppResourceLocator.url(forResource: "LocalizationAliases", withExtension: "json"),
    ...
    static var baseBundle: Bundle {
        AppResourceLocator.baseBundle
    }
}

private extension AppLanguage {
    var localizationBundle: Bundle {
        AppResourceLocator.localizedBundle(for: resourceIdentifiers) ?? L10n.baseBundle
    }
}
