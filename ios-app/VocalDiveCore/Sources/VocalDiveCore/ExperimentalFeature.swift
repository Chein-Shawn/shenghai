...
public enum ExperimentalFeatureCatalog {
    ...
    public static let singToDismissAlarm = ExperimentalFeature(
        ...
        subtitle: "A wake-up challenge that asks the user to sing a whole song before VocalDive marks the alarm resolved.",
        status: .concept,
        safetyNotice: "Experimental only. VocalDive can schedule an alert and run the singing challenge after the app opens, but it cannot guarantee an alarm keeps ringing, records, or remains impossible to stop while the app is closed, locked, powered off, muted, or blocked by system settings.",
        intendedUse: [
            "Motivational wake-up practice for users who want singing to be part of their morning routine.",
            "A full-song pitch and coverage challenge inside VocalDive before the app-level alarm state is marked resolved.",
        ...
        protocolSteps: [
            ...
            ExperimentalProtocolStep(
                id: "open",
                title: "Open VocalDive challenge",
                instruction: "The user opens VocalDive from the alert and starts the singing challenge.",
                targetMetric: "challengeStarted"
            ),
            ExperimentalProtocolStep(
                id: "sing",
                title: "Sing the whole song",
                instruction: "Sing the selected song while VocalDive tracks note coverage and pitch closeness.",
    ...
    public static func makeSingToDismissAlarmPlan(
        ...
        SingToDismissAlarmPlan(
            ...
            platformLimitation: "On iOS 17/macOS 14, VocalDive can use notifications and in-app pitch tracking, but cannot force microphone tracking or unstoppable ringing while the app is closed or the screen is off.",
    ...
    private static func sampleTextRhythmPrompt(category: TextPromptCategory) -> TextRhythmPrompt {
        ...
        case .fiction:
            return TextRhythmPrompt(
                ...
                rightsNote: "Original VocalDive sample text."
            )
        case .news:
            return TextRhythmPrompt(
                id: "sample-news",
