# VocalDive Design, Awards, and Portfolio Strategy

Date: 2026-06-06

## Product UI Direction

VocalDive should not copy MuseScore Studio or forScore. It should borrow the product logic that matters:
...
- VocalDive's own layer: vocal-part practice, live pitch feedback, OMR uncertainty review, and long-term practice history.
...
- One Xcode project: `ios-app/VocalDive.xcodeproj`
- One shared Swift package: `ios-app/VocalDiveCore`
...
Useful lessons for VocalDive:

- Interaction: controls must feel native to the platform. For VocalDive, the key interaction is not a generic dashboard; it is touching a measure, hearing the target voice, singing, and seeing immediate pitch feedback.
- Inclusivity: Guitar Wiz won in Inclusivity for supporting musicians with spoken instruction and accessibility features. VocalDive can compete here if it supports Dynamic Type, high contrast, voice guidance, color-independent feedback, and beginner-friendly language.
- Innovation: Apple highlights novel use of Apple technologies. VocalDive should use on-device audio analysis, Core ML/Create ML where useful, Apple Pencil correction on iPad, SharePlay or spatial rehearsal later, and privacy-preserving practice analytics.
- Visuals and Graphics: Tide Guide won with clear, beautiful data presentation. VocalDive should make pitch history and progress charts visually precise, not decorative.
- Social Impact: VocalDive can frame itself around music education access, choir self-practice, and reducing dependence on paid accompaniment/coaching hours.
...
- Red Dot Design Award: strongest if VocalDive becomes a product system, for example app plus microphone/hardware/music stand accessory.
- Fast Company Innovation by Design: useful if VocalDive can show measurable impact in music education or accessibility.
...
Create ML is useful, but should not be forced into the MVP. It fits VocalDive in these places:
...
Possible bridge from VocalDive to COMPACT:
...
- VocalDive audio timeline -> calcium imaging event timeline: pitch deviation detection can become a general temporal-event detection framework.
...
Do not merge the products too early. Keep VocalDive as the public app. Keep COMPACT-related work as a research toolkit module: time-series alignment, QC, and interactive review for biological imaging.
...
2. VocalDive Research Paper / Poster
...
4. Bio-Signal Timeline Toolkit
   - Translate VocalDive's audio timeline architecture to microscopy/calcium imaging event review.
   - Evidence: lab-use tool, advisor feedback, possible workshop poster.

5. Hardware VocalDive
...
VocalDive can also be your own deliberate-practice system:
...
This section folds the user's newly created Goals table into VocalDive's awards and portfolio strategy.
...
- Status: Not started
- VocalDive positioning: this is the direct summer MVP target. Present VocalDive as an AI / information service for music education and personal training, not just a technical demo.
...
- Suggested story: VocalDive lowers the barrier for choir self-practice by making intonation, memorization, and part practice measurable.
...
- Status: Not started
- Type: Assumption
- VocalDive positioning: create a polished VocalDive Playground / Swift micro-demo around one complete interaction: load a short score, play the target pitch, sing, and see sharp/flat feedback.
...
- Status: Not started
- VocalDive positioning: this is not a normal competition. After launch, use App Store Connect nomination to pitch VocalDive for featuring.
...
- Status: Not started
- VocalDive positioning: a pure app may fit brand/communication design, but Red Dot becomes stronger if VocalDive evolves into a complete app + hardware / practice kit product system.
...
- Suggested story: VocalDive turns abstract vocal training into a visible, reviewable, cumulative practice system.
